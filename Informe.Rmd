...
**Otra def no se cuál es más clara** Años de educación promedio Años de educación promedio que reciben las personas de 25 años y más durante su vida, basados en los niveles de logros educacionales de la población transformados en años de educación de acuerdo con la duración teórica de cada nivel de educación a la que se asiste.(creo que esta se entiende más: soy sofi)

Resulta necesario aclarar que para la rama de educación, al tomarse dos indicadores en vez de uno, primero se calcula el índice de dimensión de ambos y, a continuación, se obtiene la media aritmética de los dos índices resultantes.

_La utilización de la media aritmética de dos índices de educación permite una sustituibilidad perfecta entre años medios de escolaridad y los años esperados de escolaridad, lo que parece correcto dado que muchos países en desarrollo tienen un bajo escolaridad entre los adultos, pero están deseosos de lograr la escolaridad universal en primaria y secundaria de los niños en edad escolar._ (lo ponemos o no? es de lo que estaba en inglés) (hay que ponerlo para justificar pq se usan las dos y no una sola pero no queda tan claro si es que se agrega los años esperados por esto de los paises en desarrollo o si lo q se agrega es los años promedios, se podria explicar más)
...
*va en la parte de Años esperados de escolaridad*

El valor se obtiene con la estimación del coeficiente que acompaña al país en el modelo lineal $y=\alpha+\beta \text{ año}+\varepsilon$ (que valor?? no queda claro)

La fórmula de cálculo utilizada para obtener este indicador
es la siguiente: (que calculo? aclarar que es lo que se esta explicando aca)

$$\sum_{i=5}^{17} \frac{\text{Asistencia a la educación de personas con edad i}}{\text{Total de personas con la edad i}}$$

Por otro lado, se limita la edad de 5 a 17 años debido a que en el país se tiene un enfoque importante en que las personas inicien su etapa escolar en niveles de transición y kínder, y finalicen al menos la educación secundaria. Se considera que con este nivel educativo al menos las personas pueden acceder a oportunidades de educación especializada no solamente en universidades sino también opciones técnicas.

## Nivel estándar de vida decente

INGRESO O PRODUCTO NACIONAL BRUTO
A veces dice que es lo mismo y otras que no

El bajo valor mínimo para el Ingreso Nacional Bruto (en inglés Gross Nacional Income GNI) per cápita, 100 dólares, se justifica por la considerable cantidad de producción de subsistencia y producción no comercial no medida en economías cercanas al mínimo, que no se captura en los datos oficiales. El máximo se establece en 75,000 dólares per cápita. Kahneman y Deaton (2010) han demostrado que prácticamente no hay ganancia en desarrollo humano y bienestar con un ingreso anual per cápita superior a 75,000 dólares. *Actualmente*, solo cuatro países (Brunei Darussalam, Liechtenstein, Qatar y Singapur) superan el techo de ingresos per cápita de 75,000 dólares.
(este minimo y maximo no era para el PBI o al final era para el PNB???)
...
# Críticas IDH + Modif que ya existen
