...
```{r}
#Creacion nuevo indice economico1
bbdd_descrip$Dim_Econ4 <- bbdd_descrip$Dim_Econ*sqrt(1-bbdd_descrip$G_30/100)
...
bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Econ)) %>%
  mutate(jerarquiaecon0 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Econ1)) %>%
  mutate(jerarquiaecon1 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Econ2)) %>%
  mutate(jerarquiaecon2 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Econ3)) %>%
  mutate(jerarquiaecon3 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Econ4)) %>%
  mutate(jerarquiaecon4 = row_number()) %>%
  arrange(desc(row_number()))


bbdd_descrip <- bbdd_descrip %>%
  mutate(difecon1 = jerarquiaecon0 - jerarquiaecon1) 


bbdd_descrip <- bbdd_descrip %>%
  mutate(difecon2 = jerarquiaecon0 - jerarquiaecon2) 


bbdd_descrip <- bbdd_descrip %>%
  mutate(difecon3 = jerarquiaecon0 - jerarquiaecon3) 


bbdd_descrip <- bbdd_descrip %>%
  mutate(difecon4 = jerarquiaecon0 - jerarquiaecon4) 
...
$$SaludVida_{nacer} = Salud_{nacer} + Vida_nacer$$
...
bbdd_descrip <- bbdd_descrip %>%
  ...
  mutate(jerarquiasalud0 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Salud2)) %>%
  mutate(jerarquiasalud2 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Salud3)) %>%
  mutate(jerarquiasalud3 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  arrange(desc(Dim_Salud4)) %>%
  mutate(jerarquiasalud4 = row_number()) %>%
  arrange(desc(row_number()))

bbdd_descrip <- bbdd_descrip %>%
  mutate(difsalud2 = jerarquiasalud0 - jerarquiasalud2) 


bbdd_descrip <- bbdd_descrip %>%
  mutate(difsalud3 = jerarquiasalud0 - jerarquiasalud3) 


bbdd_descrip <- bbdd_descrip %>%
  mutate(difsalud4 = jerarquiasalud0 - jerarquiasalud4) 
...
```{r}
bbdd_final <- bbdd_descrip %>%
  select(Codigo,Pais,Dim_Educ,Dim_Econ1,Dim_Salud2)

colnames(bbdd_final) <- c("Codigo","Pais","Dim_Educ","Dim_Econ","Dim_Salud")

# Guardar bbdd3 en un archivo Excel
write.xlsx(bbdd_final, "bbdd_final.xlsx")
write.xlsx(bbdd_descrip, "../bbdd_descrip.xlsx")
