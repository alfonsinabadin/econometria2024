...
colnames(bbdd_descrip) <- c("Codigo","Pais","Dim_Econ","GNIPC","G")

```

# Indice Economico

GNIPC = Ingreso nacional bruto per capita (Acotado en maximo y minimo seleccionados)
G = Indice de Ginni
...
GNIPCA = GNI Per cápita ajustado por Gini
