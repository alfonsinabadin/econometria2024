...
bbdd_descrip <- datos_juntos_sinNA %>%
  select(codigo, Pais,dim_econ,gnipc2_2019,gini,vida_nacer,salud_nacer)

colnames(bbdd_descrip) <- c("Codigo","Pais","Dim_Econ","GNIPC","G","Vida_nacer","Salud_nacer")
...
## Calculo actual 
$$\frac{\ln(GNIPC)-\ln(100)}{\ln(75000)-\ln(100)}$$
...
$$\frac{\ln(GNIPCA)-\ln(100)}{\ln(75000)-\ln(100)}$$
...
bbdd_descrip$Dim_Econ1 <- (log(bbdd_descrip$GNIPCA)-log(100))/(log(75000)-log(100))
...
ggsave("boxplot_comparacion1_1.jpg", plot = boxecon_1)
...
ggsave("histograma_0_1.jpg", plot = histindice0_1)
...
ggsave("histograma_1_1.jpg", plot = histindice1_1)
...
$$\frac{\ln(GNIPC)-\ln(100)}{\ln(75000)-\ln(100)} * (1-G/100)$$
```{r}
#Creacion nuevo indice economico1
...
# Guardar el gráfico en un archivo JPEG con un nombre específico
ggsave("boxplot_comparacion1_2.jpg", plot = boxecon_2)
...
ggsave("histograma_1_2.jpg", plot = histindice1_2)
...
bbdd_descrip$Dim_Econ3 <- (log(bbdd_descrip$GNIPCA_30)-log(100))/(log(75000)-log(100))
...
# Guardar el gráfico en un archivo JPEG con un nombre específico
ggsave("boxplot_comparacion1_3.jpg", plot = boxecon_3)
...
ggsave("histograma_1_3.jpg", plot = histindice1_3)
...
# Guardar el gráfico en un archivo JPEG con un nombre específico
ggsave("boxplot_comparacion1_4.jpg", plot = boxecon_4)
...
ggsave("histograma_1_4.jpg", plot = histindice1_4)
